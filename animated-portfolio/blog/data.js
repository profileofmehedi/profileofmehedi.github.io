...
const POSTS = [
    ...
    },
    {
        ...
        "excerpt": "Library analogy, IMemoryCache vs Redis, Cache-Aside pattern, Absolute/Sliding expiration, service layer code, cache invalidation, key naming, common mistakes এবং production tips।",
        "category": "performance",
        "tags": [
            "Redis",
            "Caching",
    ...
    },
    {
        ...
        "excerpt": "Book analogy, SDLC/STLC বিস্তারিত, phase mapping table, shift-left, Agile perspective, real e-commerce example, common misconceptions এবং interview answers।",
        "category": "sqa",
        "tags": ["SDLC", "STLC", "SoftwareTesting", "QA", "SQA", "ShiftLeft", "TestingPhases"],
        "date": "Jul 07, 2026",
        "readTime": "14 min",
        "icon": "fas fa-rotate",
    ...
    },
    {
        ...
        "excerpt": "Factory analogy, ৬টি phase বিস্তারিত (entry/exit, deliverables), e-commerce real example, Agile STLC, common mistakes এবং interview answers — STLC সম্পূর্ণ Bangla guide।",
        "category": "sqa",
        "tags": ["STLC", "TestingPhases", "QA", "SQA", "TestPlanning", "RTM", "TestClosure"],
        "date": "Jul 07, 2026",
        "readTime": "15 min",
        "icon": "fas fa-list-check",
    ...
    },
    {
        ...
        "excerpt": "Road trip analogy, IEEE 829 সব ১৫টি section, Entry/Exit criteria, Agile vs Waterfall, Sprint test plan example, risk table, template checklist এবং interview answers।",
        "category": "sqa",
        "tags": ["TestPlan", "QA", "SQA", "IEEE829", "TestManagement", "Scope", "EntryExitCriteria"],
        "date": "Jul 07, 2026",
        "readTime": "17 min",
    ...
    },
    {
        ...
        "excerpt": "War analogy, Strategy vs Plan table, 10 document sections, 6 strategy types (Risk-Based, Analytical, Reactive...), decision guide, e-commerce example, template এবং interview answers।",
        "category": "sqa",
        "tags": ["TestStrategy", "QA", "SQA", "RiskBased", "TestManagement", "TestPlan", "Agile"],
        "date": "Jul 07, 2026",
        "readTime": "16 min",
        "icon": "fas fa-chess",
    ...
    },
    {
        ...
        "excerpt": "Recipe analogy, field-by-field guide, Positive/Negative/Boundary examples, BVA, Equivalence Partitioning, Login test suite, 8 golden rules, good vs bad comparison এবং interview answers।",
        "category": "sqa",
        "tags": ["TestCase", "QA", "SQA", "BoundaryValue", "ManualTesting", "TestDesign", "BVA"],
        "date": "Jul 07, 2026",
        "readTime": "15 min",
        "icon": "fas fa-pencil",
    ...
    },
    {
        ...
        "excerpt": "Hospital analogy, status table, real e-commerce example, Jira tips, 5 golden rules of bug report, common mistakes এবং interview answers — Bug Life Cycle সম্পূর্ণ Bangla guide।",
        "category": "sqa",
        "tags": ["BugLifeCycle", "Defect", "QA", "SQA", "BugTracking", "Jira", "DefectManagement"],
        "date": "Jul 07, 2026",
        "readTime": "14 min",
        "icon": "fas fa-bug",
    ...
    },
    {
        ...
        "excerpt": "4 combination examples, severity levels, triage meeting, decision matrix, interview answers — Severity vs Priority practical Bangla guide।",
        "category": "sqa",
        "tags": ["Severity", "Priority", "BugTriage", "DefectManagement", "Interview", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "16 min",
        "icon": "fas fa-triangle-exclamation",
    ...
    },
    {
        ...
        "excerpt": "Full vs partial regression, suite building, CI/CD automation, smoke-sanity-regression flow — Regression Testing-এর সম্পূর্ণ practical Bangla guide।",
        "category": "sqa",
        "tags": ["RegressionTesting", "TestAutomation", "CI", "SmokeTesting", "AgileTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
    ...
    },
    {
        ...
        "excerpt": "Smoke vs Sanity vs Regression, checklists, Agile flow, automation tips — দুটো quick test-এর পার্থক্য practical Bangla guide with real examples।",
        "category": "sqa",
        "tags": ["SmokeTesting", "SanityTesting", "RegressionTesting", "BuildVerification", "AgileTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "16 min",
    ...
    },
    {
        ...
        "excerpt": "Session-Based ET, charter template, SFDIPOT heuristic, tours, Agile integration — Exploratory Testing-এর সম্পূর্ণ practical Bangla guide (ET ≠ random testing)।",
        "category": "sqa",
        "tags": ["ExploratoryTesting", "SessionBased", "TestCharter", "ManualTesting", "AgileTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
    ...
    },
    {
        ...
        "excerpt": "JWT validation, account lockout, user enumeration, SQL injection, multi-device session — Login API-এর 31টি test case সহজ Bangla guide (কী করবেন + কী expect করবেন)।",
        "category": "sqa",
        "tags": ["APITesting", "LoginAPI", "Authentication", "JWT", "AccountLockout", "SecurityTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
        "icon": "fas fa-key",
    ...
    },
    {
        ...
        "excerpt": "Field validation, duplicate email, password policy, email verification, SQL/XSS — Registration API-এর 31টি test case সহজ Bangla guide (কী করবেন + কী expect করবেন)।",
        "category": "sqa",
        "tags": ["APITesting", "RegistrationAPI", "InputValidation", "EmailVerification", "SecurityTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
    ...
    },
    {
        ...
        "excerpt": "Idempotency, gateway timeout, amount tampering, bKash/Nagad, refund, webhook — Payment API-এর 34টি test case সহজ Bangla guide (কী করবেন + কী expect করবেন)।",
        "category": "sqa",
        "tags": ["APITesting", "PaymentAPI", "Idempotency", "FinTech", "Refund", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "20 min",
    ...
    },
    {
        ...
        "excerpt": "Send/verify flow, expiry, replay attack, brute force, resend limit, OTP leak check — OTP API-এর 33টি test case সহজ Bangla guide (কী করবেন + কী expect করবেন)।",
        "category": "sqa",
        "tags": ["APITesting", "OTP", "SecurityTesting", "2FA", "BruteForce", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
    ...
    },
    {
        ...
        "excerpt": "Multipart upload, magic byte check, MIME spoofing, path traversal, size limit — File Upload API-এর 36টি test case সহজ Bangla guide (কী করবেন + কী expect করবেন)।",
        "category": "sqa",
        "tags": ["APITesting", "FileUpload", "SecurityTesting", "MIMESpoofing", "MagicBytes", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "18 min",
    ...
    },
    {
        ...
        "excerpt": "Relevance ranking, fuzzy match, injection, Bengali/Unicode, autocomplete, search+filter combo — Search API-এর 48টি production-ready test case professional Bangla guide।",
        "category": "sqa",
        "tags": ["APITesting", "SearchAPI", "SQLInjection", "RelevanceRanking", "PerformanceTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "20 min",
        "icon": "fas fa-magnifying-glass",
    ...
    },
    {
        ...
        "excerpt": "Offset vs cursor pagination, partial last page, duplicate/missing records, sort+filter combo, deep offset performance — Pagination API-এর 49টি production-ready test case professional Bangla guide।",
        "category": "sqa",
        "tags": ["APITesting", "Pagination", "BoundaryValue", "DataIntegrity", "CursorPagination", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "20 min",
    ...
    },
    {
        ...
        "excerpt": "Filter leak, multi-filter AND/OR, injection, cross-tenant bypass, facet count, pagination consistency — Filtering API-এর 55টি production-ready test case professional Bangla guide।",
        "category": "sqa",
        "tags": ["APITesting", "Filtering", "QueryParams", "FilterLeak", "SecurityTesting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "20 min",
        "icon": "fas fa-filter",
    ...
    },
    {
        ...
        "excerpt": "Locale collation, NULL tie-breaking, multi-column sort, pagination continuity, SQL injection, UI sync — Sorting API-এর 53টি production-ready test case professional Bangla guide।",
        "category": "sqa",
        "tags": ["APITesting", "Sorting", "Pagination", "DataIntegrity", "LocaleSorting", "QA", "SQA"],
        "date": "Jul 07, 2026",
        "readTime": "20 min",
    ...
    },
    {
        ...
        "excerpt": "Sync vs Async export, data accuracy, authorization, timezone, async job lifecycle, PII masking, performance load — Report Download API-এর 42টি production-ready test case (text format)।",
        "category": "sqa",
        "tags": ["APITesting", "ReportExport", "PDF", "Excel", "DataAccuracy", "PerformanceTesting", "QA"],
        "date": "Jul 07, 2026",
        "readTime": "22 min",
